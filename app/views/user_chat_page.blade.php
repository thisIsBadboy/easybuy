        ...
        <div style="margin-top:0%;" class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
            <div class="panel panel-info">
                ...
                {{--<div class="panel-heading">
                    <div class="panel-title">To Admin</div>
                </div>--}}

                <div class="panel-body" >
                    <div id="messageBox" style="height:250px; overflow-x:auto;"></div>
                </div>
    ...
    $(document).ready(function(){
        ...
        setInterval(function(){
            $.ajax({
                type:"POST",
                url:'get_message',
                data:{'userId':userId, 'sender':'admin'},
                dataType:'json',
        ...
        $("#send").click(function(){
            ...
            if(message!=""){
                ...
                $.ajax({
                      type: "POST",
                      url: 'send_to_admin', 
                      data: {'userId': userId, 'userName':userName, 'message':message, 'status':'not seen', 'sender':'user'},
                      success: function(data){
                        //alert(data);
